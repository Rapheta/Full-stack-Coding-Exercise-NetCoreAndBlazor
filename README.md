...
Este es un pequeño ejercicio sobre la creación de un CRUD mediante la tecnología **.NET EntityFrameWork Core** y **Blazor**. Lo primero que se debe hacer es conectar un servicio .NET CORE a una base de datos. Mediante Blazor nos conectaremos a dicho servicio y crear así una Single Page Application.

| Blazor | .NET Core | SQL Server |
|------------------- |---------------- |---------------- |
|<p align="center"><img src="https://github.com/Rapheta/Full-stack-Coding-Exercise-NetCoreAndBlazor/blob/master/images/blazor.png" width="60%"/></p>|<p align="center"><img src="https://github.com/Rapheta/Full-stack-Coding-Exercise-NetCoreAndBlazor/blob/master/images/netcore.png" width="32%"/></p>|<p align="center"><img src="https://github.com/Rapheta/Full-stack-Coding-Exercise-NetCoreAndBlazor/blob/master/images/sql-server.png" width="70%"/></p>|
...
- Creación de la aplicación Blazor
